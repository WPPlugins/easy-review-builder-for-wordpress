...
*/
/*  Copyright © 2009, 2010, 2011, 2012, 2013, 2014, 2015 dyerware
...
' . $cmte . '
	...
	{	
      ...
      $ratingScore= (int)$chartConfig["score"];
      ...
      if ($firstRow == false && $chartConfig['overall'] == true)
       {
           ...
           // Does user wish to override the average?
           if ($ratingScore >= 0 && $ratingScore <= $ratingMax)
           {
             $average = $ratingScore;
           }
